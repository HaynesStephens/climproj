...
# OutputFreq seconds
kwargs['OutputFile']     = '/scratch/midway/shanshans/radconv1_defaultSST_co2_290solar_ccm3_emanuel_i270_290solar.nc'
...
kwargs['RestartFile']    = '/project/moyer/script_lib/climt_output/default_SST/ccm3_emanuel/320_solar/temp_test_exps/radconv1_defaultSST_co2_i270_290solar_ccm3_emanuel.nc'
...
rad = climt.radiation(UpdateFreq=kwargs['dt']*50, scheme='ccm3')
...
RunLength   = 10950.   # Total length of run (days)
