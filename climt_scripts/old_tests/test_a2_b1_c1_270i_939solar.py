...
# NO usurf, so all zonal wind given same value for spurring convection.
#############################
# PARAMETERS/NAMES TO ALTER #
#############################
co2_ppm = 270
nc_name = 'test_a2_b1_c1_270i_939solar.nc'
...
for i in range(run_length):
    ...
    # state['time'] += timestep
    state['eastward_wind'].values[:] = 5.0 # default value of old climt turbulence that Shanshan didn't seem to change
