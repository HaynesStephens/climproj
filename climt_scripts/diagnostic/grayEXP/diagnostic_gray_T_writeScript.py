...
def createRun(input_ppm):
    ...
    template_path = '/home/haynes13/code/python/climproj/climt_scripts/diagnostic/grayEXP/diagnostic_gray_T_template.py'
    job_path = '/home/haynes13/code/python/climproj/climt_scripts/diagnostic/grayEXP/T/{0}.py'.format(job_name)
    print(job_path)
    ...
    test_dir = 'diagnostic/grayEXP/T/' # Needs to end in an '/'
    job_dir, sbatch_filename = newSbatch.newSbatch(base_dir, test_dir, job_name)
    return job_dir, sbatch_filename

os.system('mkdir -p /home/haynes13/code/python/climproj/climt_scripts/diagnostic/grayEXP/T/')
