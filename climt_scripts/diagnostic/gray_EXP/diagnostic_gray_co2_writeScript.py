...
def createRun(input_ppm):
    ...
    template_path = '/home/haynes13/code/python/climproj/climt_scripts/diagnostic/gray_EXP/diagnostic_gray_co2_template.py'
    job_path = '/home/haynes13/code/python/climproj/climt_scripts/diagnostic/gray_EXP/co2/{0}.py'.format(job_name)
    print(job_path)
    ...
    test_dir = 'diagnostic/gray_EXP/co2/' # Needs to end in an '/'
    job_dir, sbatch_filename = newSbatch.newSbatch(base_dir, test_dir, job_name)
    return job_dir, sbatch_filename

os.system('mkdir -p /home/haynes13/code/python/climproj/climt_scripts/diagnostic/gray_EXP/co2/')
