...
#insol = 320
input_ppm = 1215
nc_name = 'diagnostic_short_qradcst_T_input1215.nc'
#####################
import copy
from sympl import (
...
restart_file_name = '/project2/moyer/old_project/haynes/climt_files/varying_co2_qRadCst/' \
                    'i270_320solar_qRadCst/i270_320solar_qRadCst_pkl_eq.pkl'
restart_file = open(restart_file_name, 'rb')
restart_state = pickle.load(restart_file)

q_file_name = '/project2/moyer/old_project/haynes/climt_files/control_fullstore/' \
                    'i270_320solar_fullstore/i270_320solar_fullstore_pkl_eq.pkl'
q_file = open(q_file_name, 'rb')
q_state = pickle.load(q_file)
control_q = q_state['specific_humidity'].copy()
...
fixed_T_file_name = '/project2/moyer/old_project/haynes/climt_files/' \
               'varying_co2_qRadCst/i{0}_320solar_qRadCst/i{0}_320solar_qRadCst_pkl_eq.pkl'.format(input_ppm)
