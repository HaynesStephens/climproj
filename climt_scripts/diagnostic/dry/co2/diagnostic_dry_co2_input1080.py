...
#insol = 320
input_ppm = 1080
nc_name = 'diagnostic_dry_co2_input1080.nc'
#####################
import copy
...
restart_file_name = '/project2/moyer/old_project/haynes/climt_files/' \
                    'control_fullstore/i270_320solar_fullstore/i270_320solar_fullstore_pkl_eq.pkl'
...
dry_state['specific_humidity'].values[:] = np.zeros((28, 1, 1))
radiation_lw_dry = FixedInputWrapper_v2(radiation_lw, dry_state)
radiation_sw_dry = FixedInputWrapper_v2(radiation_sw, dry_state)
######################################


time_stepper = AdamsBashforth([radiation_lw_dry, radiation_sw_dry, slab, moist_convection])
