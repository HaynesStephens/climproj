...
def createRun(input_ppm):
    ...
    template_path = '/home/haynes13/code/python/climproj/climt_scripts/diagnostic/gray/diagnostic_gray_co2_template.py'
    job_path = '/home/haynes13/code/python/climproj/climt_scripts/diagnostic/gray/co2/{0}.py'.format(job_name)
    print(job_path)
    ...
    test_dir = 'diagnostic/gray/co2/' # Needs to end in an '/'
