...
basepath = '/project2/moyer/old_project/haynes/climt_files/varying_co2/320solar/'
...
outpath = '/home/haynes13/code/python/climproj/data_calculated/EQ.varyco2.320solar.anomalies.csv'
f = open(outpath, 'w')
