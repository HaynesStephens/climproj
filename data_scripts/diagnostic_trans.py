...
def get_df(fname, input_ppm):
    ...
    lw_up       = pkl['upwelling_longwave_flux_in_air'][0]
    lw_dn       = pkl['downwelling_longwave_flux_in_air'][0]
...
outpath = '/home/haynes13/code/python/climproj/' \
          'data_calculated/diagnostic_{0}_{1}_trans.csv'.format(run_type, diag_var)
f = open(outpath, 'w')
