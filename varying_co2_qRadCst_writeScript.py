...
def createRun(co2_ppm, irradiance, insol):
    job_name = 'i{0}_{1}solar_qRadCst'.format(co2_ppm, insol)

    template_path = '/home/haynes13/code/python/climproj/climt_scripts/varying_co2_qRadCst/varying_co2_qRadCst_template.py'
    job_path = '/home/haynes13/code/python/climproj/climt_scripts/varying_co2_qRadCst/{0}.py'.format(job_name)
    print(job_path)
    ...
    test_dir = 'varying_co2_qRadCst/' # Needs to end in an '/' love
    job_dir, sbatch_filename = newSbatch.newSbatch(base_dir, test_dir, job_name)
    return job_dir, sbatch_filename

os.system('mkdir -p /home/haynes13/code/python/climproj/climt_scripts/varying_co2_qRadCst/')
